...
myBuilder = gl.MoleculeBuilder(os.path.join(gl.GLYCOSYLATOR_PATH, 'support/toppar_charmm/carbohydrates.rtf'),
...
NAG2, del_atoms, bonds2 = myBuilder.build_from_patch(myNAG.atom_group, 2, 'NAG', myNAG.get_chain(), myNAG.get_segname(),
                                                     '14bb')
