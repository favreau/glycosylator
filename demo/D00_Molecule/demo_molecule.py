...
print('Current dihedral for the torsional angle #%d (%d): %d', idx, torsional, myMan9.measure_dihedral_angle(idx))
...
print('New dihedral angle: %d', myMan9.measure_dihedral_angle(idx))
print('#' * 50)
